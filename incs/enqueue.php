...
function awesome_scripts_enqueue(){
    ...
    wp_enqueue_style( 'star-rating', get_template_directory_uri().'/assets/css/star-rating.min.css', array('awesomestyle'), '1.0.0', 'all' );
    ...
    wp_enqueue_script( 'star-rating-js', get_template_directory_uri().'/assets/js/star-rating.min.js', array( 'jquery' ), '1.0.0', true );
}
